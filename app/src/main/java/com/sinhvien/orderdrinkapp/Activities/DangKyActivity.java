...
public class DangKyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.dangky_layout);
    ...
    public void backFromRegister(View view){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(DangKyActivity.this,pairs);
    ...
    public void byBundleNextSignupScreen(String hoTen, String tenDN, String eMail, String sDT, String matKhau){
        ...
        Intent intent = new Intent(getApplicationContext(), XacNhanDKActivity.class);
