...
public class XacNhanDKActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xacnhandk_layout);
        ...
        Bundle bundle = getIntent().getBundleExtra(DangKyActivity.BUNDLE);
        if(bundle != null) {
        ...
        BTN_signup_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ktra != 0){
                    Toast.makeText(XacNhanDKActivity.this,getResources().getString(R.string.add_sucessful),Toast.LENGTH_SHORT).show();
                    callLoginFromRegister();
                }else{
                    Toast.makeText(XacNhanDKActivity.this,getResources().getString(R.string.add_failed),Toast.LENGTH_SHORT).show();
                }
            }
        });
