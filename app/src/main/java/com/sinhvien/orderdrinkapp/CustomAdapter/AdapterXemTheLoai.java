...
public class AdapterXemTheLoai extends RecyclerView.Adapter<AdapterXemTheLoai.ViewHolder>{

    Context context;
    int layout;
    List<LoaiMonDTO> loaiMonDTOList;

    public AdapterXemTheLoai(Context context, int layout, List<LoaiMonDTO> loaiMonDTOList){
    ...
    @Override
    public void onBindViewHolder(AdapterXemTheLoai.ViewHolder holder, int position) {
