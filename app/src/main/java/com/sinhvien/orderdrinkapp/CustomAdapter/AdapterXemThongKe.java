...
public class AdapterXemThongKe extends RecyclerView.Adapter<AdapterXemThongKe.ViewHolder>{
    ...
    public AdapterXemThongKe(Context context, int layout, List<DonDatDTO> donDatDTOList){
    ...
    @Override
    public void onBindViewHolder(AdapterXemThongKe.ViewHolder holder, int position) {
